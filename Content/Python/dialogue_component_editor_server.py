...
def script_describe_all_user_structs() -> str:
    return (
        ...
        "assets = []\n"
        "try:\n"
        "    assets = list(ar.get_assets_by_class('UserDefinedStruct', True))\n"
        "except Exception:\n"
        "    # UE 5.1+ requires TopLevelAssetPath; UserDefinedStruct lives in CoreUObject\n"
        "    try:\n"
        "        tlap = unreal.TopLevelAssetPath('/Script/CoreUObject', 'UserDefinedStruct')\n"
        "        assets = list(ar.get_assets_by_class(tlap))\n"
